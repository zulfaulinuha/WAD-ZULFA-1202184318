	...
	if (isset($_POST['simpan'])) {
		...
		if(!in_array($ext,$ekstensi) ) {
			...
			if($ukuran < 1044070){		
				...
				$sql = "INSERT INTO `events` (`name`, `deskripsi`, `gambar`, `kategori`, `tanggal`, `mulai`, `berakhir`, `tempat`, `harga`, `benefit`) 
				VALUES ('$name', '$deskripsi', '$xx', '$kategori', '$tgl', '$jm', '$jb', '$tempat', '$harga', '$for_query')";
